...
final class DBContract {
    ...
    static abstract class Song {
        ...
        static ContentValues getContentValues(com.slimsimapps.troff.Models.Song song) {
        ...
        static com.slimsimapps.troff.Models.Song getObject(Cursor cursor) {
            com.slimsimapps.troff.Models.Song song = new com.slimsimapps.troff.Models.Song();
    ...
    static abstract class Marker {
        ...
        static ContentValues getContentValues(com.slimsimapps.troff.Models.Marker marker) {
            ContentValues cv = new ContentValues();
        ...
        static com.slimsimapps.troff.Models.Marker getObject(Cursor cursor) {
            com.slimsimapps.troff.Models.Marker marker = new com.slimsimapps.troff.Models.Marker();
